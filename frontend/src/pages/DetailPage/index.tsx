    ...
    const handleJudgeArbitration = async () => {
        ...
        try {
            ...
            const response = await fetch(
                "/agent-api/e74d3d91-491d-0c68-9e66-c19544352ca0/message",
                {
                    method: "POST",
                    headers: {
                    ...
                    body: JSON.stringify({
                        ...
                        text: `                        
                            ...
                            The scenario is a JavaScript project where the first user completed the code, and the second user completed security testing and documentation. They were allocated 3500 and 1000 tokens, respectively, but the second user felt undervalued, leading to a discussion.  
